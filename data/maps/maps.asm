...
MapGroup_LakeOfRage:
	...
	map LakeOfRageMagikarpHouse, TILESET_HOUSE, INDOOR, LANDMARK_ROUTE_12, MUSIC_ROUTE_12, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Lavender:
	...
	map Route12, TILESET_KANTO, ROUTE, LANDMARK_LAKE_OF_RAGE, MUSIC_LAKE_OF_RAGE, FALSE, PALETTE_AUTO, FISHGROUP_QWILFISH_NO_SWARM
...
MapGroup_Cianwood:
	...
	map CianwoodPharmacy, TILESET_HOUSE, INDOOR, LANDMARK_CIANWOOD_CITY, MUSIC_ROUTE_47, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	...
	map CianwoodDevHouse, TILESET_HOUSE, INDOOR, LANDMARK_CIANWOOD_CITY, MUSIC_ROUTE_47, FALSE, PALETTE_DAY, FISHGROUP_SHORE
