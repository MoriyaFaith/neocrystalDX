...
FalknerGroup:
	...
	db 13, HOOTHOOT,   PECK, MUD_SLAP, FORESIGHT, HYPNOSIS
...
WhitneyGroup:
	...
	db 21, JIGGLYPUFF,   DOUBLESLAP, ROLLOUT, SING, DEFENSE_CURL
...
BugsyGroup:
	...
	db 16, SPINARAK,   POISON_STING, SCARY_FACE, NIGHT_SHADE, NO_MOVE
	db 17, LEDIAN,     HEADBUTT, SUPERSONIC, BARRIER, FURY_CUTTER
	db 19, SCYTHER,    QUICK_ATTACK, LEER, PURSUIT, FURY_CUTTER
	db -1 ; end
...
MortyGroup:
	...
	db 25, MISDREAVUS, CONFUSE_RAY, PSYBEAM, PAIN_SPLIT, SHADOW_BALL
...
Rival1Group:
	...
	db 22, DROWZEE,    HYPNOSIS, CONFUSION, DISABLE, HEADBUTT
	db 21, HORSEA,     WATER_GUN, SMOKESCREEN, LEER, NO_MOVE
	db 23, BAYLEEF,    GROWL, REFLECT, RAZOR_LEAF, POISONPOWDER
	db 22, SNEASEL,    QUICK_ATTACK, FAINT_ATTACK, SCRATCH, ICY_WIND
	db -1 ; end

	; RIVAL1 (8)
	db "?@", TRAINERTYPE_MOVES
	db 22, DROWZEE,    HYPNOSIS, CONFUSION, DISABLE, HEADBUTT
	db 21, ELEKID,     QUICK_ATTACK, LEER, THUNDERPUNCH, LIGHT_SCREEN
	db 23, QUILAVA,    LEER, SMOKESCREEN, EMBER, QUICK_ATTACK
	db 25, SNEASEL,    QUICK_ATTACK, FAINT_ATTACK, SCRATCH, ICY_WIND
	db -1 ; end

	; RIVAL1 (9)
	db "?@", TRAINERTYPE_MOVES
	db 22, DROWZEE,    HYPNOSIS, CONFUSION, DISABLE, HEADBUTT
	db 21, HOUNDOUR,   EMBER, BITE, SMOG, ROAR
...
ChampionGroup:
	...
	db 55, STEELIX,    IRON_TAIL, EARTHQUAKE, ROCK_SLIDE, HYPER_BEAM
	db 56, KINGDRA,    HYDRO_PUMP, DRAGONBREATH, BLIZZARD, HYPER_BEAM
	db 55, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 56, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 57, DRAGONITE,  FIRE_BLAST, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 41, GOLEM,      SELFDESTRUCT, ROCK_SLIDE, ROLLOUT, EARTHQUAKE
	db 41, RHYDON,     BODY_SLAM, ROCK_SLIDE, EARTHQUAKE, HORN_DRILL
	db 42, AERODACTYL, WING_ATTACK, ANCIENTPOWER, FLAMETHROWER, STEEL_WING
	db 44, STEELIX,    BIND, ROCK_SLIDE, BIDE, SANDSTORM
...
BeautyGroup:
	...
	db 22, SKIPLOOM,     SYNTHESIS, TAIL_WHIP, TACKLE, POISONPOWDER
...
PokemaniacGroup:
	...
	db 21, LICKITUNG,  LICK, SUPERSONIC, CUT, NO_MOVE
	db -1 ; end
...
RedGroup:
	; RED (1)
	db "RED@", TRAINERTYPE_NICKNAME | TRAINERTYPE_MOVES | TRAINERTYPE_ITEM
	db 81, PIKACHU,    "PIKA@",      LIGHT_BALL,   THUNDERBOLT, IRON_TAIL, THUNDER_WAVE, SUBSTITUTE
	db 75, AERODACTYL, "AERO@",      KINGS_ROCK,   HYPER_BEAM, FLY, EARTHQUAKE, ROCK_SLIDE
	db 77, GYARADOS,   "GYARA@",     BERSERK_GENE, HYDRO_PUMP, HYPER_BEAM, SURF, BODY_SLAM
	db 79, SNORLAX,    "SNOR@",      LEFTOVERS,    BODY_SLAM, REST, SNORE, EARTHQUAKE
	db 82, VENUSAUR,   "SAUR@",      SCOPE_LENS,   GIGA_DRAIN, SLUDGE_BOMB, POISONPOWDER, SOLARBEAM
	db 84, POLIWRATH,  "POLI@",      MYSTIC_WATER, SURF, DOUBLE_TEAM, DYNAMICPUNCH, MIND_READER
	db -1 ; end
